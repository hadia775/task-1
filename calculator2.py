...
def clear_field():
    global calculation
    calculation=""
    text_result.deletion(1.0,"end")
    root= tk.Tk()
root.geometry("300x275")
text_result =tk.Text(root,height="2",width=16,font=("Arial",24))
text_result.grid(columspace=5)
...
btn_4=tk.Button(root,text="5",command=lambda:add_to_calculation(5),width=5,font=("Arial,14"))
btn_4.grid(row=3,column=2)
btn_4=tk.Button(root,text="6",command=lambda:add_to_calculation(6),width=5,font=("Arial,14"))
...
btn_8=tk.Button(root,text="0",command=lambda:add_to_calculation(0),width=5,font=("Arial,14"))
...
btn_clear(row=6,column=1,columnspan=2)
